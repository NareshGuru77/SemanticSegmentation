...
\section{Data analysis:}
	...
	\subsection{Analysing the "atWork\_full" variant:}
		\begin{itemize}
			...
			\begin{figure}[!htb]
				\centering
				\includegraphics[scale=0.4]{percentage_of_pixels_f}
			...
			\begin{figure}[!htb]
			\centering
				\includegraphics[scale=0.4]{percentage_of_pixels_f_noB}
			...
			\begin{figure}[!htb]
			\centering
				\includegraphics[scale=0.4]{class_count_f}
			...
			\begin{figure}[!htb]
			\centering
				\includegraphics[scale=0.4]{class_count_f_noB}
	...
	\subsection{Analysing the "atWork\_size\_invariant" variant:}
		...
		\begin{itemize}
			...
			\begin{figure}[!htb]
			\centering
				\includegraphics[scale=0.4]{percentage_of_pixels_si}
				\caption{.}
				\label{Fig:14}
			\end{figure}
			...
			\begin{figure}[!htb]
			\centering
				\includegraphics[scale=0.4]{percentage_of_pixels_si_noB}
				\caption{.}
				\label{Fig:15}
			\end{figure}
			...
			\begin{figure}[!htb]
			\centering
				\includegraphics[scale=0.4]{class_count_si}
				\caption{.}
				\label{Fig:16}
			\end{figure}
			...
			\begin{figure}[!htb]
			\centering
				\includegraphics[scale=0.4]{class_count_si_noB}
				\caption{.}
				\label{Fig:17}
			\end{figure}
		\end{itemize}
	...
	\subsection{Analysing the "atWork\_similar\_shapes" variant:}
		...
		\begin{itemize}
			...
			\begin{figure}[!htb]
			\centering
				\includegraphics[scale=0.4]{percentage_of_pixels_sh}
				\caption{.}
				\label{Fig:18}
			\end{figure}
			...
			\begin{figure}[!htb]
			\centering
				\includegraphics[scale=0.4]{percentage_of_pixels_sh_noB}
				\caption{.}
				\label{Fig:19}
			\end{figure}
			...
			\begin{figure}[!htb]
			\centering
				\includegraphics[scale=0.4]{class_count_sh}
				\caption{.}
				\label{Fig:20}
			\end{figure}
			...
			\begin{figure}[!htb]
			\centering
				\includegraphics[scale=0.4]{class_count_sh_noB}
				\caption{.}
				\label{Fig:21}
			\end{figure}
		\end{itemize}
	...
	\subsection{Analysing the "atWork\_binary" variant:}
		...
		\begin{itemize}
			...
			\begin{figure}[!htb]
				...
				\begin{subfigure}{.49\textwidth}
  					\centering
  					\includegraphics[width=.9\linewidth]{percentage_of_pixels_b}
  					\caption{}
  					\label{Fig:22a}
				\end{subfigure}%
				\begin{subfigure}{.49\textwidth}
  					\centering
  					\includegraphics[width=.93\linewidth]{class_count_b}
  					\caption{}
  					\label{Fig:22b}
				\end{subfigure}%
			\caption{.}
		...
		\begin{itemize}
			...
			\begin{figure}[!htb]
			\centering
				\includegraphics[scale=0.4]{percentage_of_pixels_rf}
				\caption{.}
				\label{Fig:18}
			\end{figure}
			...
			\begin{figure}[!htb]
			\centering
				\includegraphics[scale=0.4]{percentage_of_pixels_rf_noB}
				\caption{.}
				\label{Fig:19}
			\end{figure}
			...
			\begin{figure}[!htb]
			\centering
				\includegraphics[scale=0.4]{class_count_rf}
				\caption{.}
				\label{Fig:20}
			\end{figure}
			...
			\begin{figure}[!htb]
			\centering
				\includegraphics[scale=0.4]{class_count_rf_noB}
				\caption{.}
				\label{Fig:21}
			\end{figure}
		\end{itemize}
...
Meta-data of the dataset is provided in table \ref{Table:3}. These numbers hold true for all four dataset variants and also for the shades of white dataset. Initially, 30 images were captured for each of the 18 objects leading to a total of 540 images. However, 1 image of "axis" object and 2 images of "s40\_40\_B" were removed as they were blurred.
