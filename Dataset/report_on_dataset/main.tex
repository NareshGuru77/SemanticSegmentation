...
\hline 
\textbf{backgrounds\_path} & \makecell{-} & \makecell{} \\ 
\hline 
\textbf{image\_path} & \makecell{-} & \makecell{} \\ 
\hline 
\textbf{label\_path} & \makecell{-} & \makecell{} \\ 
\hline 
\textbf{real\_img\_type} & \makecell{'.jpg'} & \makecell{} \\ 
\hline 
\textbf{min\_obj\_area} & \makecell{20} & \makecell{} \\ 
\hline 
\textbf{max\_obj\_area} & \makecell{70} & \makecell{} \\ 
\hline 
\textbf{save\_label\_preview} & \makecell{False} & \makecell{} \\ 
\hline 
\textbf{save\_obj\_det\_label} & \makecell{False} & \makecell{} \\ 
\hline  
\textbf{save\_mask} & \makecell{False} & \makecell{} \\ 
\hline 
\textbf{image\_save\_path} & \makecell{-} & \makecell{} \\ 
\hline 
\textbf{label\_save\_path} & \makecell{-} & \makecell{} \\ 
\hline 
\textbf{preview\_save\_path} & \makecell{None} & \makecell{} \\ 
\hline 
\textbf{obj\_det\_save\_path} & \makecell{None} & \makecell{} \\ 
\hline 
\textbf{mask\_save\_path} & \makecell{None} & \makecell{} \\ 
\hline 
\textbf{start\_index} & \makecell{0} & \makecell{} \\ 
\hline 
\textbf{name\_format} & \makecell{'\%05d'} & \makecell{} \\
\hline 
\textbf{remove\_clutter} & \makecell{True} & \makecell{} \\
\hline 
\textbf{num\_images} & \makecell{20} & \makecell{} \\ 
\hline 
\textbf{max\_objects} & \makecell{10} & \makecell{} \\ 
\hline 
\textbf{num\_regenerate} & \makecell{100} & \makecell{} \\ 
\hline 
\textbf{min\_distance} & \makecell{100} & \makecell{} \\ 
\hline 
\textbf{max\_occupied\_area} & \makecell{0.8} & \makecell{} \\ 
\hline 
\textbf{scale\_ranges} & \makecell{None} & \makecell{} \\ 
\hline 
\end{tabular}
