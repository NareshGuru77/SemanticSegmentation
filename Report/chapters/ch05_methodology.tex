...
This work makes use of the quantization method available in tensorflow source. "eightbit" mode provided by the script is used. % https://github.com/tensorflow/tensorflow/blob/master/tensorflow/tools/quantization/quantize_graph.py. 
