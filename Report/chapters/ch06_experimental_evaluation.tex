...
\section{Effects of quantizing the inference graph}
	...
	\begin{itemize}
		...
		\item \textbf{Inference from the results}: Across all the variants and network backbones of deepLabv3+, the 8bit model occupies less disk memory than its corresponding full precision model. The 
	\end{itemize}
	...
	\begin{table}
		...
		\hline
		\multicolumn{ 1}{|l|}{Dataset variant} & \multicolumn{ 4}{l|}{mIOU in \%} \\ \cline{ 2- 5}
		\multicolumn{ 1}{|l|}{} & \multicolumn{1}{l|}{MobileNetv2} & \multicolumn{1}{l|}{MobileNetv2-8} & \multicolumn{1}{l|}{Xception} & \multicolumn{1}{l|}{Xception-8} \\ \hline
		atWork\_full & 77.69 & 66.08 & 89.41 & 87.86 \\ \hline
		atWork\_size\_invariant & 82.95 & 68.88 & 91.19 & 89.3 \\ \hline
		atWork\_similar\_shapes & 81.91 & 72.22 & 90.75 & 87.5 \\ \hline
		atWork\_binary & 96.1 & 93.49 & 98.32 & 96.92 \\ \hline
		\end{tabular}
