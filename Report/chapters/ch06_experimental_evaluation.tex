...
\label{section:quant}
	...
	\begin{figure}
		...
		\caption{The plot shows mIOU and disk memory occupied by both the network backbones of DeepLabv3+ on all the variants of the variety of backgrounds of dataset. The green rectangle represents the desired region in which the mIOU is in the range [90,100] and occupied disk memory is in the range (0,10].}
		\label{Fig:quant}
	\end{figure}
...
This chapter addresses the different experiments performed to evaluate the DeepLabv3+ segmentation model and the created dataset. 
