...
\textbf{[Incomplete]}
	...
	\subsection{Surface area of the objects}
		...
		\begin{table}
			...
			\begin{tabular}{|c|c|c|c|c|c|c|c|}
			\hline 
  			\textbf{Object name} & \textbf{Assumed shape} & \textbf{Surface area ($cm^2$)} \\ 
			\hline
  			 f20\_20\_B & \makecell{cuboid} & 88 \\ 
			\hline
  			 s40\_40\_B & \makecell{cuboid} & 192 \\ 
			\hline
  			 f20\_20\_G & \makecell{cuboid} & 88 \\ 
			\hline
  			 s40\_40\_G & \makecell{cuboid} & 192 \\ 
			\hline
  			 m20\_100 & \makecell{cylinder + hexagonal prism -\\ hexagon - circle} &  \\ 
			\hline
  			 m20 & \makecell{hollow hexagonal prism} &  \\ 
			\hline
  			 m30 & \makecell{hollow hexagonal prism} &  \\ 
			\hline
  			 r20 & \makecell{hollow cylinder} & 78.54 \\ 
			\hline
  			 bearing\_box\_ax01 & \makecell{cuboid with \\ cylindrical hole} &  \\ 
			\hline
  			 bearing & \makecell{hollow cylinder} & 31.75 \\ 
			\hline
  			 axis & \makecell{hollow cylinder} &  \\ 
			\hline
  			 distance\_tube & \makecell{hollow cylinder} & 22.62 \\ 
			\hline
  			 motor & \makecell{cylinder} & 142.5 \\ 
			\hline
  			 container\_box\_blue & \makecell{} &  \\ 
			\hline
  			 container\_box\_red & \makecell{} &  \\ 
			\hline
  			 bearing\_box\_ax16 & \makecell{cuboid with \\ cylindrical hole} &  \\ 
			\hline
  			 em\_01 & \makecell{cuboid} &  \\ 
			\hline
  			 em\_02 & \makecell{cuboid} &  \\ 
			\hline
			\end{tabular}
