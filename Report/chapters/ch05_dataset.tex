...
These drawbacks could be overcome by randomly placing objects on a variety of different background images automatically by coding an algorithm. This algorithm is called the artificial image generation algorithm.
